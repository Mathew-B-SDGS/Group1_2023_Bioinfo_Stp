...
log_file = 'app.log'
max_bytes = 1024  # Size in bytes before rollover
backup_count = 3  # Number of backup files to keep
rotation_handler = RotatingFileHandler(log_file, maxBytes=max_bytes, backupCount=backup_count)
...
# There will be 3 handlers, one to write log messages to a file and the other for printing the messages to the output
